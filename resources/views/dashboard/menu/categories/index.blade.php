        ...
        <ul class="list-group  list-group-flush">
            @foreach($cats as $cat)
                <li class="list-group-item text-center"  >
                    @if($loop->last)
                        <span class="fa-icon-holder mr-4"></span>
                    @else
                        <a href="{{route('category.order_bottom', $cat->order)}}" class="fa-icon-holder mr-4" >
                    ...
                    @if($loop->index !== 0)
                        <a href="{{route('category.order_top', $cat->order)}}" class="fa-icon-holder ml-4" >
                    ...
                    @else
                        <span class="fa-icon-holder ml-4"></span>
                    @endif
                </li>
            @endforeach
        </ul>
